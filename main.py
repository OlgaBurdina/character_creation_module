...
def attack(char_name: str, char_class: str):
    """Вычисляет уроны нанесенные пртивнику разными персонажами."""
...
def defence(char_name: str, char_class: str):
    """Выводит значение блокировки урона каждым персонажем."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str):
    """Применении специального умения каждым персонажем."""
    if char_class == 'warrior':
        return (
...
def choice_char_class():
    """Вывод информации персонаже, выбор персонажа игроком."""
    approve_choice = None
    char_class = None
